        ...
        <div className="ticker-tape py-1">
          <div className="animate-marquee inline-block">
            <span className="font-heading text-[10px] text-navy font-bold tracking-wider">
              &nbsp;&nbsp;🔥 <Link href="/games/wiki-race" className="hover:underline">Wiki Race</Link> &nbsp;&nbsp;🔍 <Link href="/games/hallucination-hunter" className="hover:underline">Hallucination Hunter</Link> &nbsp;&nbsp;📈 <Link href="/games/overfit" className="hover:underline">Overfit!</Link> &nbsp;&nbsp;🔤 <Link href="/games/token-blitz" className="hover:underline">Token Blitz</Link> &nbsp;&nbsp;🏈 <Link href="/games/breakaway" className="hover:underline">Breakaway</Link> &nbsp;&nbsp;🏎️ <Link href="/games/f1-racer" className="hover:underline">F1 Racer</Link> &nbsp;&nbsp;⚽ <Link href="/games/penalty-kick" className="hover:underline">Penalty Kick</Link> &nbsp;&nbsp;🏈 <Link href="/games/field-goal" className="hover:underline">Field Goal Frenzy</Link> &nbsp;&nbsp;🏴 <Link href="/games/guess-the-flag" className="hover:underline">Guess the Flag</Link> &nbsp;&nbsp;
              🔥 <Link href="/games/wiki-race" className="hover:underline">Wiki Race</Link> &nbsp;&nbsp;🔍 <Link href="/games/hallucination-hunter" className="hover:underline">Hallucination Hunter</Link> &nbsp;&nbsp;📈 <Link href="/games/overfit" className="hover:underline">Overfit!</Link> &nbsp;&nbsp;🔤 <Link href="/games/token-blitz" className="hover:underline">Token Blitz</Link> &nbsp;&nbsp;🏈 <Link href="/games/breakaway" className="hover:underline">Breakaway</Link> &nbsp;&nbsp;🏎️ <Link href="/games/f1-racer" className="hover:underline">F1 Racer</Link> &nbsp;&nbsp;⚽ <Link href="/games/penalty-kick" className="hover:underline">Penalty Kick</Link> &nbsp;&nbsp;🏈 <Link href="/games/field-goal" className="hover:underline">Field Goal Frenzy</Link> &nbsp;&nbsp;🏴 <Link href="/games/guess-the-flag" className="hover:underline">Guess the Flag</Link> &nbsp;&nbsp;
            </span>
          </div>
        </div>
