...
const SENTENCES: TokenSentence[] = [
  ...
  },
  {
    ...
    tokens: 8,
    boundaries: ["Neural", " networks", " can", " approximate", " any", " continuous", " function", "."],
    difficulty: 2,
    category: "technical",
  },
  {
    ...
    tokens: 9,
    boundaries: ["Grad", "ient", " descent", " optim", "izes", " the", " loss", " function", " iteratively."],
    difficulty: 2,
    category: "technical",
  },
  {
  ...
  },
  {
    ...
    tokens: 10,
    boundaries: ["Back", "prop", "agation", " computes", " grad", "ients", " through", " the", " computational", " graph."],
    difficulty: 2,
    category: "technical",
  },
  {
  ...
  },
  {
    ...
    tokens: 11,
    boundaries: ["The", " meeting", " has", " been", " rescheduled", " to", " next", " Monday", " at", " ", "3pm."],
    difficulty: 2,
    category: "everyday",
  },
  {
    ...
    tokens: 9,
    boundaries: ["Kub", "ernetes", " orchestr", "ates", " container", "ized", " applications", " at", " scale."],
    difficulty: 2,
    category: "technical",
  },
  {
  ...
  },
  {
    ...
    tokens: 8,
    boundaries: ["We", " need", " to", " ref", "actor", " this", " legacy", " codebase."],
    difficulty: 2,
    category: "technical",
  },
  {
  ...
  },
  {
    ...
    tokens: 12,
    boundaries: ["async", " function", " fetch", "Data", "(", "url", ":", " string", "):", " Promise", "<Response", "> {"],
    difficulty: 3,
    category: "code",
  },
  {
  ...
  },
  {
    ...
    tokens: 14,
    boundaries: ["docker", " run", " -", "d", " -", "p", " ", "808", "0", ":", "80", " ng", "inx", ":latest"],
    difficulty: 3,
    category: "code",
  },
  {
  ...
  // ---- Numbers and math (difficulty 2-3) ----
  {
    ...
    tokens: 12,
    boundaries: ["The", " answer", " is", " ", "3", ".", "14", "159", "265", "358", "979", "."],
    difficulty: 3,
    category: "numbers",
  },
  {
  ...
  },
  {
    ...
    tokens: 11,
    boundaries: ["SHA", "-", "256", ":", " a", "1", "b", "2", "c", "3", "d4e5f6..."],
    difficulty: 3,
    category: "numbers",
  },
  {
  ...
  // ---- Emoji and Unicode (difficulty 3) ----
  {
    ...
    tokens: 10,
    boundaries: ["I", " love", " pizza", "!", " \u{1F355}", "\u{1F355}", "\u{1F355}", "", "", ""],
    difficulty: 3,
    category: "unicode",
  },
  {
    ...
    tokens: 12,
    boundaries: ["\u{1F600}", "", "", "\u{1F601}", "", "", "\u{1F602}", "", "", "\u{1F923}", "", ""],
    difficulty: 3,
    category: "unicode",
  },
  {
  ...
  },
  {
    ...
    tokens: 10,
    boundaries: ["¿", "Cu", "á", "ntos", " tokens", " ti", "ene", " esta", " orac", "ión?"],
    difficulty: 3,
    category: "unicode",
  },
  {
  ...
  // ---- AI/ML Terminology (difficulty 2-3) ----
  {
    ...
    tokens: 13,
    boundaries: ["Fine", "-", "tuning", " a", " pre", "-trained", " model", " on", " domain", "-specific", " data", ".", ""],
    difficulty: 2,
    category: "ai",
  },
  {
    ...
    tokens: 10,
    boundaries: ["R", "LH", "F", " aligns", " language", " models", " with", " human", " preferences", "."],
    difficulty: 2,
    category: "ai",
  },
  {
  ...
  },
  {
    ...
    tokens: 11,
    boundaries: ["Ret", "riev", "al", "-aug", "mented", " generation", " combines", " search", " with", " LL", "Ms."],
    difficulty: 3,
    category: "ai",
  },
  {
  ...
  },
  {
    ...
    tokens: 12,
    boundaries: ["Temperature", "=", "0", ".", "7", " produces", " more", " creative", " but", " less", " determin", "istic output."],
    difficulty: 3,
    category: "ai",
  },
  {
    ...
    tokens: 13,
    boundaries: ["Chain", "-of", "-th", "ought", " prompting", " improves", " reasoning", " in", " LL", "Ms", ".", "", ""],
    difficulty: 3,
    category: "ai",
  },
  {
    ...
    tokens: 11,
    boundaries: ["Byte", "-pair", " encoding", " merges", " frequent", " character", " pairs", " into", " tokens", ".", ""],
    difficulty: 2,
    category: "ai",
  },
  {
  ...
  },
  {
    ...
    tokens: 15,
    boundaries: ["A", " ", "70", "B", " parameter", " model", " requires", " approximately", " ", "140", "GB", " of", " memory", " in", " FP16."],
    difficulty: 3,
    category: "ai",
  },
  {
  ...
  },
  {
    ...
    tokens: 14,
    boundaries: ["Mr", ".", " Smith", ",", " Jr", ".", " earned", " his", " Ph", ".", "D", ".", " in", " 2019."],
    difficulty: 3,
    category: "punctuation",
  },
  {
  ...
  // ---- Longer / Paragraph (difficulty 2-3) ----
  {
    ...
    tokens: 11,
    boundaries: ["In", " a", " hole", " in", " the", " ground", " there", " lived", " a", " hobb", "it."],
    difficulty: 2,
    category: "everyday",
  },
  {
    ...
    tokens: 16,
    boundaries: ["The", " mit", "och", "ondria", " is", " the", " powerhouse", " of", " the", " cell", ",", " converting", " nutrients", " into", " ATP", " through cellular respiration."],
    difficulty: 2,
    category: "technical",
  },
  {
  ...
  },
  {
    ...
    tokens: 9,
    boundaries: ["Super", "cal", "if", "rag", "il", "istic", "exp", "ial", "idocious"],
    difficulty: 3,
    category: "everyday",
  },
  {
    ...
    tokens: 15,
    boundaries: ["Pne", "umon", "oult", "ram", "icro", "scop", "ics", "ilic", "ov", "olcan", "ocon", "iosis", " is", " a", " lung disease."],
    difficulty: 3,
    category: "technical",
  },
  {
  ...
  },
  {
    ...
    tokens: 27,
    boundaries: ["The", " regex", " pattern", ":", " ^[", "a", "-", "zA", "-Z", "0", "-", "9", ".", "_%", "+-", "]+@", "[a", "-z", "A", "-Z", "0", "-", "9", ".-", "]+\\", ".[", "a-zA-Z]{2,}$"],
    difficulty: 3,
    category: "code",
  },
  {
  ...
  },
  {
    ...
    tokens: 11,
    boundaries: ["Lor", "em", " ipsum", " dolor", " sit", " amet", ",", " consectetur", " adip", "iscing", " elit."],
    difficulty: 2,
    category: "everyday",
  },
  {
  ...
  },
  {
    ...
    tokens: 13,
    boundaries: ["Type", "Error", ":", " Cannot", " read", " properties", " of", " undefined", " (", "reading", " '", "map", "')"],
    difficulty: 3,
    category: "code",
  },
  {
  ...
  },
  {
    ...
    tokens: 12,
    boundaries: ["The", " United", " Nations", " was", " founded", " on", " October", " ", "24", ",", " ", "1945."],
    difficulty: 2,
    category: "everyday",
  },
  {
    ...
    tokens: 8,
    boundaries: ["She", " sells", " seas", "hells", " by", " the", " seas", "hore."],
    difficulty: 2,
    category: "everyday",
  },
  {
  ...
  },
  {
    ...
    tokens: 14,
    boundaries: ["HTTP", "/", "2", " uses", " multiplex", "ing", " to", " send", " multiple", " requests", " over", " a", " single", " TCP connection."],
    difficulty: 2,
    category: "technical",
  },
  {
  ...
  },
  {
    ...
    tokens: 18,
    boundaries: ["Run", " the", " command", ":", " python", "3", " -", "m", " v", "env", " .", "v", "env", " &&", " source", " .", "v", "env/bin/activate"],
    difficulty: 3,
    category: "code",
  },
  {
